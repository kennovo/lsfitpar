/* $Id: gopt.c,v 1.1 2015/05/01 23:17:59 kenno Exp $ */
/* slightly modified version of
 * gopt.c version 8.1 by Tom Vajzovic <tom.viza@gmail.com> PUBLIC DOMAIN 2003-8
...
/* Misnomer because no sorting is done, and the functions gopt() and gopt_arg() crawl
 * through all of opt_specs instead of bsearch()ing. Should really be "gopt_tokenize". */
        ...
        if( '-' == (*arg_p)[1] )
          ...
          {{{
            ...
            if( opt_spec_p-> flags & GOPT_ARG ){
              ...
              if( (char*)0 + 1 == next_option-> arg ){  /* Yes, NULL+1. This is a 1337 way to determine if  */
                ++arg_p;                                /* the strchr on the previous line returned NULL... */
